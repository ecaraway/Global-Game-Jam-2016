...
public class Wander1 : MonoBehaviour {
    ...
    void Start() {
		...
		//		debugRing = debugDraw.createRing (Vector2.zero, wanderRadius);
    ...
    public Vector2 getSteering() {
		...
		Vector2 targetPosition = transform.position + (orientationToVector (characterOrientation) * wanderOffset);
