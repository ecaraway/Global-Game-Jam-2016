...
public class Wander2 : MonoBehaviour {
    ...
    void Start()
    {
        ...
        wanderTarget = new Vector2(wanderRadius * Mathf.Cos(theta), wanderRadius * Mathf.Sin(theta), 0f);
    ...
    public Vector2 getSteering()
    {
        ...
        wanderTarget += new Vector2(Random.Range(-1f, 1f) * jitter, Random.Range(-1f, 1f) * jitter, 0f);
        ...
        Vector2 targetPosition = transform.position + transform.right * wanderDistance + wanderTarget;
